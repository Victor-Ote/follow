...
class BabelIntroScreen extends StatefulWidget {
  const BabelIntroScreen({
  ...
  @override
  State<BabelIntroScreen> createState() => _BabelIntroScreenState();
}

class _BabelIntroScreenState extends State<BabelIntroScreen> {
